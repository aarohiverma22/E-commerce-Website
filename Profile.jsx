...
const Profile = () => {
  ...
  return (
    <div className="h-auto p-3 space-y-2 lg:w-60 md:w-60  sm:w-[600px] xs:w-[350px] dark:bg-gray-50 dark:text-gray-800">
      ...
      <div className="divide-y dark:divide-gray-300 ">
        <ul className="pt-2 pb-4 space-y-1 text-sm">
            ...
            <Link className="flex items-center p-2 space-x-3 rounded-md">
              ...
              <div className="flex justify-center items-center gap-3">
                <input
                  ...
                  name=""
                  id=""
                  className=" input-xs  border-black text-black bg-white"
                  // autoFocus/
                  placeholder="Search..."
                />
              </div>
          ...
          <li className="flex items-center">
            ...
            <Link to="/addCourse" className="capitalize">
              Add course
            </Link>
          </li>
          <li>
            <Link className="flex items-center p-2 space-x-3 rounded-md">
              ...
              <span className="capitalize">watch tutorials</span>
            </Link>
          </li>
          <li>
            <Link className="flex items-center p-2 space-x-3 rounded-md">
