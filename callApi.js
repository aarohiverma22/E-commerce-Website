...
async function create(formData) {
  try {
    const response = await axios.post(createApi, formData); //send post req to create API
...
export async function getAllCards(){
  try{
const response = await axios.get(getAllCardsApi)  //get request to retrieve all cards
...
export async function deleteCard(id){
  try{
const response = await axios.delete(`${deletecardApi}/${id}`)   //rquest to delete card with specific id
if(response){
